...
public class Update_theme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Update_theme.this,Fragment_recycle.class));
            }
        });
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(Update_theme.this, "Theme modifié avec succés" , Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(Update_theme.this, "Error : " + task.getException().getMessage() , Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Update_theme.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
